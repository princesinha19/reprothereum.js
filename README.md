...
#### Note:
You can run `npm run clear` to remove all the build javascript files.
...
Also, before submitting PR, Please run the command `npm run clear` to remove all the unnecessary build files. And, make sure your fork is up to date with the main repository.
